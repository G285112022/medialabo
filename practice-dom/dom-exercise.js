...
p0.textContent = '写真表と都市の緯度経度のページです。';
p0.style="text-emphasis: sesame green;"
h2.insertAdjacentElement('afterend' , p0);
...
photo.insertAdjacentElement('beforeend', p1);
...
// 練習4-5 箇条書き追加プログラム
let uls = document.querySelector('ul#location')
for (D of data) {
	let li = document.createElement('li');
	li.textContent = D.name+' ... 緯度:'+ D.lat + ' , 経度:'+ D.lng;
	uls.insertAdjacentElement('beforeend' ,li);
}
